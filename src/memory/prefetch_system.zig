...
pub const PrefetchSystem = struct {
    ...
    pub fn prefetchEmbeddingData(
        self: *PrefetchSystem,
        embedding_data: *const dod_layout.DODGraphData,
        start_index: u32,
        count: u32,
        hint: PrefetchHint
    ) void {
    ...
    pub fn prefetchBFS(
        self: *PrefetchSystem,
        graph_data: *const dod_layout.DODGraphData,
        current_level: []const u64,
        next_level: []const u64
    ) void {
        if (!self.config.enable_software_prefetch) return;
    ...
    pub fn prefetchDijkstra(
        self: *PrefetchSystem,
        graph_data: *const dod_layout.DODGraphData,
        priority_queue: []const u64,
        visited: []const bool
    ) void {
        if (!self.config.enable_software_prefetch) return;
    ...
    fn prefetchGraphTraversalPattern(
        self: *PrefetchSystem,
        graph_data: *const dod_layout.DODGraphData,
        node_indices: []const u32
    ) void {
