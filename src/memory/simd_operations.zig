...
pub const SIMDBatchProcessor = struct {
    ...
    pub fn processNodeBatch(
        node_data: *dod_layout.DODGraphData,
    ...
    pub fn processEdgeBatch(
        edge_data: *dod_layout.DODGraphData,
    ...
    pub fn processEmbeddingBatch(
        embedding_data: *dod_layout.DODGraphData,
    ...
    pub fn filterNodesByKindSIMD(
        node_data: *const dod_layout.DODGraphData,
        kind: u8,
        result_indices: []u32
    ) u32 {
        var count: u32 = 0;
    ...
    pub fn filterEdgesByLabelSIMD(
        edge_data: *const dod_layout.DODGraphData,
        label: u16,
        result_indices: []u32
    ) u32 {
        var count: u32 = 0;
    ...
    pub fn computeEmbeddingSimilaritySIMD(
        embedding1: [constants.data.embedding_dimensions]f32,
        embedding2: [constants.data.embedding_dimensions]f32
    ) f32 {
